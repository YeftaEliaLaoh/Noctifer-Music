...
else if(isset($_GET['zon']))
{
	...
	$jsonurl = "https://www.e-solat.gov.my/index.php?r=esolatApi/TakwimSolat&period=week&zone=".$kodzon; # url of JAKIM eSolat JSON data
	...
	// $arrwaktu = array(
	// 	"waktu_imsak" => $prayerTime['imsak'],
	// 	"waktu_subuh" => $prayerTime['fajr'],
	// 	"waktu_syuruk" => $prayerTime['syuruk'],
	// 	"waktu_zohor" => $prayerTime['dhuhr'],
	// 	"waktu_asar" => $prayerTime['asr'],
	// 	"waktu_maghrib" => $prayerTime['maghrib'],
	// 	"waktu_isyak" => $prayerTime['isha'],
